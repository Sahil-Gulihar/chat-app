    ...
    <div className="messages flex flex-col gap-3  flex-grow p-3 overflow-y-scroll">
      ...
      messages?.length > 0
       && messages?.map((message) => {
        ...
        const messageBgColor = fromMe ? 'bg-msg-color' : 'bg-gray-100';
        ...
        return (
          ...
          <img
            ...
            alt="avatar"
          />
          <div className={`${borderClassname} ${messageBgColor} ${textColor} mt-2 font-sans  w-fit max-w-[70%] h-auto text-sm p-2 flex justify-center items-center flex-wrap`}>
            {message.body}
