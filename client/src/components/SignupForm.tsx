  ...
  return(
    <form className="w-full font-0 text-[#353535] flex flex-col gap-12" action="/">
      ...
      <section className="w-full flex gap-2">
        <InputField labelName="First Name" fieldName="firstname" formData={formData} placeholderText="John" fieldType="text" setFormData={setFormData} />
        <InputField labelName="Last Name" fieldName="lastname" formData={formData} placeholderText="Doe" fieldType="text" setFormData={setFormData} />
      </section>

      <section className="w-full flex gap-2">
        <InputField labelName="Username" fieldName="username" formData={formData} placeholderText="John_Doe" fieldType="text" setFormData={setFormData} />
        <InputField labelName="Password" fieldName="password" formData={formData} placeholderText="Password" fieldType="password" setFormData={setFormData} />  
      </section>
