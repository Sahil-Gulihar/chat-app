...
const UserChat = () => {
  ...
  return (
    <main className="bg-white px-4 py-5 w-3/4 h-screen rounded-lg flex flex-col font-0">
        ...
        <>
          <div className="left w-full flex gap-2 border-b border-gray-300 pb-2">
            ...
            <div className="text text-[#353535] flex flex-col justify-center gap">
              <h3 className="text-sm font-semibold flex gap-2">{selectedConversation.firstname} {selectedConversation.lastname} 
              {isOnline ? (<div className="bg-green-600 mt-1 h-2 w-2 rounded-full"></div>) : null}
              </h3>
